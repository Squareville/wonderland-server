...
namespace {
	...
	std::map<std::string, std::function<CppScripts::Script* ()>> scriptLoader = {
		...
		{R"(scripts\newcontent\server\spawnbeeondeath.lua)", []() {return new SpawnEntityOnDeath(20310, 40.0f);}},
		{R"(scripts\newcontent\server\afv_maelstrom_crystal.lua)", []() {return new SpawnEntityOnDeath(20042, 60.0f);}},
