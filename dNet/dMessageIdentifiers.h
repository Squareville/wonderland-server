...
enum GAME_MSG : unsigned short {
	...
	GAME_MSG_PARSE_CHAT_MESSAGE = 836,
	...
	GAME_MSG_UI_MESSAGE_SERVER_TO_SINGLE_CLIENT = 1147,
	...
	GAME_MSG_SERVER_DONE_LOADING_ALL_OBJECTS = 1591,
